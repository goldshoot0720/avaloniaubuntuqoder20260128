...
public partial class MusicPlayerView : UserControl
{
    ...
    private void InitializeVLC()
    {
        try
        {
            ...
            Debug.WriteLine("VLC initialized successfully for music player");
        }
        catch (Exception ex)
        {
    ...
    public void LoadMusic(string url, string title = "Unknown Song", string artist = "Unknown Artist")
    {
        try
        {
            ...
            var songTitleText = this.FindControl<TextBlock>("SongTitleText");
            ...
            Debug.WriteLine($"Loading music: {url}");
        }
        catch (Exception ex)
        {
            Debug.WriteLine($"Failed to load music: {ex.Message}");
        }
    }
    ...
    private void Cleanup()
    {
        try
        {
            ...
            Debug.WriteLine("Music player cleanup completed");
        }
        catch (Exception ex)
        {
